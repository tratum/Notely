# Welcome to Notely contributing guide <!-- omit in toc -->
...
If you spot a problem with the docs, [search if an issue already exists](https://github.com/tratum/Notely/issues?q=is%3Aopen). If a related issue doesn't exist, you can open a new [issue](https://github.com/tratum/Notely/issues/new/choose).

#### Solve an issue

Scan through our [existing issues](https://github.com/tratum/Notely/issues) to find one that interests you. You can narrow down the search using `labels` as filters. See "[Label reference](https://docs.github.com/en/contributing/collaborating-on-github-docs/label-reference)" for more information. As a general rule, we don’t assign issues to anyone. If you find an issue to work on, you are welcome to open a PR with a fix.
...
Once your PR is merged, your contributions will be publicly visible on the [Notely Repo](https://github.com/tratum/Notely).
