...
ThemeData lightTheme = ThemeData(
    ...
    scrollbarTheme: ScrollbarThemeData(
      ...
      trackColor: WidgetStateProperty.all(const Color(0xFF37BBE6)),
      trackBorderColor: WidgetStateProperty.all(const Color(0xFF37BBE6)),
...
ThemeData darkTheme = ThemeData(
  ...
  scrollbarTheme: ScrollbarThemeData(
    ...
    trackColor: WidgetStateProperty.all(const Color(0xFFf9cacb)),
  ),
  appBarTheme: const AppBarTheme(
